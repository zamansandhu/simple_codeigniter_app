...
<div class ="small-6 text-right columns">
    <a href="login_view" class="button">Logout</a>
</div>
    <div class="container">
        <h1 style="font-size:20pt">Crud App</h1>
            ...
            if(data.status) //if success close modal and reload ajax table
            {
                ...
                Object.keys(errorMessages).forEach(function(key) {
                    if (errorMessages[key]) {
                        ...
                        $('[name="'+key+'"]').next().text(errorMessages[key]);
                    }
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea id="foo"  rows="4" cols="4"  name="address" placeholder="Address" class="form-control"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <style>
